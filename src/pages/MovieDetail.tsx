            ...
            <div className="max-w-6xl mx-auto px-6 -mt-150 relative z-10">
                <div className="flex gap-8">
                    ...
                    <div className="flex-1">
                        <p className="text-red-500 text-sm font-semibold uppercase tracking-wider mb-2">{movie.status}</p>
                        ...
                        <div className="flex flex-wrap items-center gap-3 mb-6">
                            <div className="flex items-center gap-1 bg-amber-500/20 px-3 py-1 rounded-full">
                                ...
                                <span className="text-amber-400 font-semibold text-sm">{movie.vote_average.toFixed(1)}</span>
                            </div>
