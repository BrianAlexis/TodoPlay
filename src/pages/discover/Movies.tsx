...
const Movies = () => {
    ...
    return (
        <div className='mx-auto w-full max-w-400 px-4 pb-12 pt-6 sm:px-6 lg:px-8 place-items-center'>
            ...
            <h2 className='my-10 md:mt-15 md:mb-10 text-3xl font-black leading-tight text-white md:text-5xl text-center'>All our <span className='text-red-500'>movies</span></h2>
            ...
            <button
                ...
                disabled={isLoading}
                className="flex mt-5 rounded-xl bg-red-600 p-3 md:px-6 md:py-3 text-sm font-bold text-white transition-colors hover:bg-red-500 cursor-pointer disabled:cursor-not-allowed"
            >
                {isLoading ? (
                    <>
                        Loading...
